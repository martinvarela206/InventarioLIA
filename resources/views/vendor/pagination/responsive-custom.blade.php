@if ($paginator->hasPages())
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-amber-900 bg-amber-100 border border-amber-300 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
    ...
    <div class="sm:hidden flex items-center justify-center mt-2 gap-2">
            {{-- -10 Pages Mobile --}}
            @if ($paginator->currentPage() > 10)
            <a href="{{ $paginator->url($paginator->currentPage() - 10) }}" class="px-3 py-1 border rounded bg-white text-sm">-10</a>
            @endif
