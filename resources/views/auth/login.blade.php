    ...
    <div class="flex-grow flex items-center justify-center py-12">
        <div class="w-full max-w-xs">
            <div class="flex justify-center mb-6">
                @include('common.logo', ['variant' => 'dark', 'class' => 'w-24 h-24'])
            </div>
            <form action="{{ route('login') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="text-center">
                    <a class="inline-block align-baseline font-bold text-sm text-[#dba800] hover:text-[#fbc101] transition-colors duration-200" href="{{ route('register') }}">
